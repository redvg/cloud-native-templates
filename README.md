...
- ![Python WSGI server (flask+gunicorn)](server/python-asgi) [![Maintainer](https://badgen.net/badge/maintainer/🍭redvg/black)](https://github.com/redvg)

- ![Golang RPC](server/golang-rpc) [![Maintainer](https://badgen.net/badge/maintainer/🍭redvg/black)](https://github.com/redvg)

- ![Golang gRPC unary](server/golang-grpc) [![Maintainer](https://badgen.net/badge/maintainer/🍭redvg/black)](https://github.com/redvg)

- ![Golang Kafka](server/golang-kafka) [![Maintainer](https://badgen.net/badge/maintainer/🍭redvg/black)](https://github.com/redvg)

- ![Golang Prometheus](server/golang-prom) [![Maintainer](https://badgen.net/badge/maintainer/🍭redvg/black)](https://github.com/redvg)
...
- ![Load test with k6: CRR & hammer](ops/k6) [![Maintainer](https://badgen.net/badge/maintainer/🍭redvg/black)](https://github.com/redvg)

- ![Workflow orchestration with Apache Airflow: GCP Firestore & Memorystore backup and Slack notification](ops/airflow-backup) [![Maintainer](https://badgen.net/badge/maintainer/🍭redvg/black)](https://github.com/redvg)

- ![Workflow orchestration with Apache Airflow: synchronize GCP Cloud Storage buckets](ops/airflow-gcs) [![Maintainer](https://badgen.net/badge/maintainer/🍭redvg/black)](https://github.com/redvg)
